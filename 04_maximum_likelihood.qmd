...
The least squares estimates make a good starting point: that is one of the things least squares is for
...
- Close, but not the same: the Poisson likelihood weights the small counts at the start and end of the outbreak more than squared errors do
...
The negative binomial wins clearly: the counts scatter more around the curve than a Poisson model allows
