...
[**Definition:**]{style="color:tomato"} The process of finding parameter values that make a mathematical model's predictions as close as possible to observed data.
...
[**Solution:**]{style="color:tomato"} Use additional information (e.g., known infectious period)
